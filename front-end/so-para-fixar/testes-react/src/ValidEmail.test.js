...
test('Testando se o componente não aparece caso o campo email steja vazio.', () => {
...
test('Testando se o componente possui texto vermelho ai ser digitado um e-mail inválido', () => {
  const EMAIL_USER = 'emailerrado';
  render(<ValidEmail email={EMAIL_USER} />);
  const isValidText = screen.getByTestId('id-is-email-valid');
